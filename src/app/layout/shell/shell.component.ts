...
@Component({
  ...
  template: `
    ...
    <div class="flex h-screen min-h-dvh overflow-hidden bg-fundo">
      <app-sidebar />

      <main id="conteudo-principal" class="flex min-h-0 flex-1 flex-col px-5 py-6 pb-16 md:px-8 md:py-8 lg:px-10 lg:py-9 lg:pb-9" tabindex="-1">
        <router-outlet />
      </main>
    </div>
